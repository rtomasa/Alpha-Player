...
RePlay Player is a libretro based core intended to be very simple and small. It is mainly targeted to Raspberry Pi devices since as of today, there is not any functional media player available.

The purpose is having very basic features to play both audio and video.
